...
badd +0 src/proxyModel.cpp
badd +0 inc/proxyModel.h
badd +0 README.md
badd +0 languages/es.ini
badd +0 src/mainwindow_language.cpp
badd +0 src/mainwindow_language_keyboard.cpp
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 60 - ((8 * winheight(0) + 18) / 36)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
